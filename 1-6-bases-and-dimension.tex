...
The vector space \(\mathcal{P}_n(F)\) has dimension \(n + 1\), since by \EXAMPLE{1.6.4}, \\
...
The vector space \(\mathcal{P}(F)\) is infinite-dimensional because, by \EXAMPLE{1.6.5}, it has an infinite \LID{} set, namely \(\{ 1, x, x^2, ... \}\).
Hence by (contrapositive of) \CORO{1.10.2}, \(\mathcal{P}(F)\) is infinite-dimensional.
\end{example}

In \EXAMPLE{1.6.13}, the \emph{infinite} \LID{} set \(\{1, x, x^2, ... \}\) is, in fact, a basis for \(\mathcal{P}(F)\).
...
Hence by \CORO{1.10.3}(a) the set is a basis for \(\mathcal{P}_2(\SET{R})\).
\end{example}
...
Since \(\beta\) is \LID{} and has \(n + 1\) elements, which equals to the dimension of the parent vector space \(\mathcal{P}_n(F)\), by \CORO{1.10.3}(b), \(\beta\) is a basis for \(\mathcal{P}_n(F)\).
