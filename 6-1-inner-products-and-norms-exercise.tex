...
We have said that \((A^*)^* = A\) in \DEF{6.2}, and from \CORO{6.11.1}(c), \((AB)^* = B^* A^*\); the prove is similar to \((AB)^\top = B^\top A^\top\), since adjoint also involves transpose operation.
\end{note}
...
\begin{align*}
    A_1 + \iu A_2 & = \frac{1}{2} (A + A^*) + \iu \cdot \frac{1}{2\iu}(A - A^*) \\
        ...
        & = A^*
\end{align*}
\RED{WARNING}, it seem that \(A_1 \RED{-} \iu A_2 = A\), not \(A_1 + \iu A_2 = A\).
